...
import { getOverallProgress, Module, Lesson } from "@/lib/mockData";
...
export default function CurriculumPanel({ isOpen, onClose, curriculum, skillName }: CurriculumPanelProps) {
    ...
    <>
      ...
      <aside
        className={`
          ...
          w-80 flex flex-col gap-4 p-5
          bg-[#0a0a0c] border-l border-white/5 shadow-[-10px_0_30px_rgba(0,0,0,0.5)]
